...
<body>
	<sf:form action="InsertUser" method="post" commandName="user"
		...
		<div class="container"><div ng-app="" ng-init="name='Guest'">
			<h3 align="center"><br><br>
				Hello, {{name}}<br> <small>Please
			...
			<div class="form-group">
				<label class="control-label col-sm-4" for="phno">Phone no.:</label>
				<div class="col-sm-4">
				...
				<input class="col-sm-2" type="submit" value="Submit" align="center"
